...
def extract_action(new_parsed_elemetn, parsed_element, log_fname):
...
def extract_get_element_by(parsed_element, log_fname):
    new_parsed_elemetn = {}
...
def parse(fname):
	...
	for parsed_element in data:
		new_parsed_elemetn = extract_get_element_by(parsed_element, log_fname)
		new_parsed_elemetn = extract_action(new_parsed_elemetn, parsed_element, log_fname)
