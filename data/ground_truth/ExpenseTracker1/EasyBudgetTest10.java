...
Unhendled event: swipeLeft, in line: {'get_element_by': [{'type': 'resource-id', 'value': 'welcome_view_pager'}], 'action': [{'type': 'swipeLeft', 'value': ''}]}STOPPING THE EXECUTION OF THE TEST!Unhendled event: swipeLeft, in line: {'get_element_by': [{'type': 'resource-id', 'value': 'welcome_view_pager'}], 'action': [{'type': 'swipeLeft', 'value': ''}]}STOPPING THE EXECUTION OF THE TEST!